            ...
            <div class="footer">
                <div class="footer-content">
                    <div class="footer-section feeback">
                        ...
                        <p><a href="feedback.html" class="feedback">  Give Feeback </a></p>
                    
                    </div>
                    <div class="footer-section links">
                        
                        <p><center>Radisson Blu<center></p><br>
                        <!-- <p><a href="signin.html" class="register"> Sign In/Register</a></p> -->
                    </div>
                    <div class="footer-section contact-form">
                        <div class="contact">
                            <span><i class="fa fa-phone"></i> &nbsp; 123-456-789</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <span><i class="fa fa-envelope"></i> &nbsp; info@RadissonHotels.com</span>
                        </div><br>
                        <div class="socials">
                ...
                <div class="footer-bottom">
                    &copy; RadissonHotels.com | 
                    Copyright &copy 2021 Radisson Blu Hotels Online Private Limited, India. All rights reserved
                </div>
            </div>
